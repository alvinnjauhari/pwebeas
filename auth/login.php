...
<body id="bgLogin">
            ...
            <main>
                <div class="container mt-4">
                    <div class="d-flex row justify-content-center align-items-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 d-flex justify-content-center mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Login - SMA ITS AJA</h3>
                                </div>
                                <div class="card-body">
    ...
    <script src="<?= $main_url ?>assset/sb-admmin/js/scripts.js"></script>
</body>
