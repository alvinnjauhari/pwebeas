            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="<?= $main_url?>guru/guru.php">
                        <div class="sb-nav-link-icon"><i class="fa-solid fa-chalkboard-user"></i></i></i></div>
                        Guru
                    </a>
                    <a class="nav-link" href="<?= $main_url?>index.php">
                    ...
                    <a class="nav-link" href="<?= $main_url?>index.php">
                        <div class="sb-nav-link-icon"><i class="fa-solid fa-book"><i
                                    class="fa-solid fa-user-graduate"></i></i></div>
                        Ujian
                    </a>
                    <hr class="mb-0">
